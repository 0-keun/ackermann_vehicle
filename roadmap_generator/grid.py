...
class Cell():
    ...
    def draw(self):
        ...
        if self.master != None :
            ...
            if self.fill%4==1: # straight
                fill = "dark blue"
                outline = "dark blue"
            elif self.fill%4==2: # intersection 
                fill = "blue"
                outline = "blue"
            elif self.fill%4==3: # curve
                fill = "purple"
                outline = "purple"
            else: # ground_plane
                fill = "white"
...
def OpenGrid(w):
    ...
    WorldGenerator(grid, w).generate_world()
